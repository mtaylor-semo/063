...
\subsection*{Instructions for scientific method and hypothesis testing
}

\textbf{Read all instructions in this document carefully so that you do the required work without doing extra work!}

Download from your lab Canvas page the available lab handout that you would have received in lab this week. 

\begin{itemize}
\item 02: Scientific method and hypothesis testing
%\item 02b: bacterial resistance
\end{itemize}

Watch the four part video series on the scientific method and hypothesis testing. Take notes on what you learn because the material is fair game for exams. You can also download the slides from the video. This video series is atypical. Most labs will have a pre-lab instead.

Answer all questions in the scientific method and hypothesis testing handout. Type your answers into a Word document (\textsc{pdf} is acceptable). .


%\subsubsection*{Part 2}

%Read the lab handout on bacterial resistance. You will get simulated results next week. You'll graph the results using information you learn next week.  In normal circumstances, you would have set up the lab this week and then get the results next week.  Read the handout, then prepare to receive results next week.


\textbf{Upload your answers to the drop box provided on your lab Canvas page by the start of your next scheduled lab time.}
